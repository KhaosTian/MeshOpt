...
//#include "metis_def.hpp"
#ifndef METIS_DLL
    #ifdef _WIN32
        #if defined(BUILD_METIS_DLL)
            #define METIS_DLL __declspec(dllexport)
        #elif defined(USE_METIS_DLL)
...
typedef enum { METIS_OP_PMETIS, METIS_OP_KMETIS, METIS_OP_OMETIS } moptype_et;
...
typedef enum { METIS_GTYPE_DUAL, METIS_GTYPE_NODAL } mgtype_et;
...
/*! Refinement schemes */
typedef enum { METIS_RTYPE_FM, METIS_RTYPE_GREEDY, METIS_RTYPE_SEP2SIDED, METIS_RTYPE_SEP1SIDED } mrtype_et;
...
/* Types of objectives */
typedef enum { METIS_OBJTYPE_CUT, METIS_OBJTYPE_VOL, METIS_OBJTYPE_NODE } mobjtype_et;
